<template>
  ...
  .submit-issue-container {
    background-color: #edf2f6; /* 设置整个页面的背景色 */
  ...
  form {
    ...
    background-color: #fff; /* 设置表单的背景色为白色 */
    padding: 1.5rem;
    border-radius: 8px;
  ...
  button {
    ...
    border: none;
    border-radius: 4px;
    background-color: #064a88; /* 设置按钮背景色 */
    color: #fff;
    cursor: pointer;
  }
  
  button:hover {
    background-color: #008ece; /* 设置 hover 时的背景色 */
  }
